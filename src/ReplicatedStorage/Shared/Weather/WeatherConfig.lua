...
export type FrontConfig = {
	...
	CloudsPerFront: number,
	CloudSpacing: number,
	LeadingCloudOffset: number,
	TrailingCloudOffset: number,
	MaxRenderDistance: number,
	InsideFrontFadeDistance: number,
...
local WeatherConfig: WeatherConfigType = {
	...
	Fronts = {
		...
		MaxActiveFronts = 5,
		BaseSpeed = 4,
		WindSpeedInfluence = 0.12,
		DespawnBuffer = 800,
		CloudsPerFront = 12,
		CloudSpacing = 120,
		LeadingCloudOffset = 0.6,
		TrailingCloudOffset = 0.5,
		MaxRenderDistance = 3000,
		InsideFrontFadeDistance = 200,
		DistantLightningMaxDistance = 1800,
		DistantThunderMaxDistance = 1000,
		ThunderDelayPerStud = 0.003,
	},
}
